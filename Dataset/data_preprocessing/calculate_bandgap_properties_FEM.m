function [PeakFreq, Bandwidth] = calculate_bandgap_properties_FEM(frequency, spectra)
...
% [a1 a2 b1 b2 c1 c2]
startPoints = [0.1 0.1 0.5 1 1 1];
lowerPoints = [0 0 0.2 0.2 0.03 0.03]; 
upperPoints = [Inf Inf 2 2 0.8 0.8]; 
...
model = fit(f, spectra, gaussEqn,...
            'Start', startPoints, 'Lower', lowerPoints, 'Upper', upperPoints, 'Exclude', f > 2, 'Exclude', spectra < Threshold);
