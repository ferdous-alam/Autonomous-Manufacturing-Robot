...
B = genfromtxt('A_Test12_4000.csv')  # actual signal
...
# smooth -plot function on different file-plotting on one file(different module)-calculations on another
...
# # 121 Converts amplitude ratio to decibels
...
# plt.savefig('_TransferFunc_dB.jpeg',bbox_inches='tight')
# plt.show()


# store transfer function data
# np.savetxt('_Transmission_data.csv', dbTNF)
